<html>
<head><title>Gym Management Database - Class Enrollment Table</title></head>
<body>
<?php
...
{
   echo "<form action=\"queryenrollment.php\" method=post>";
   ...
   $sql = "SELECT * FROM CLASSENROLLMENT";
   ...
   {
      echo "Enrollments: <select name=\"enrollmentID\">";
   ...
   {
      echo "<p>There are no Enrollments in the system!</p>"; 
   }
